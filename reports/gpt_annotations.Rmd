...
## Heatmap: top 50 most severe phenotypes

```{r, fig.height=8, fig.width=8}
plts$gp0
```

## Barplot: proportion reponses
...
## Boxplots: responses vs. severity scores

```{r, fig.width=8}
plts$gp2
```

## Histograms: Severity score distributions by HPO branch
